...
<html>
 ...
 <body background="images/userhome.jpeg">
  <div class="container">
           ...
           <div class="jumbotron"><frameset cols="600">
                   <iframe  src="uhome.jsp" name="fr" id="fr" width="500" height="400" frameborder="0"></iframe>
                   <!--<frame <p><embed wmode="transparent" src="http://www.xatech.com/web_gear/chat/chat.swf"
                                    quality="high" width="400" height="400" name="chat" FlashVars="id=218021820"
                                    align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" 
                                    pluginspage="http://xat.com/update_flash.php" /><br><small></small><br></p>-->
                   </frameset> 
               <div style="width: 400px; background-color: #999; z-index: 10; position: fixed; right: 0; top:220px; height: 400px;">
